...
TITLE : <input type="text" size="20" name="title" id="title" value= "${bdetail.title}" ><br>
...
<input type="hidden" name="photo_before" value="${bdetail.photo}">

<img src="board/img/${bdetail.photo}"> <br>

바꿀사진파일 : <input type="file" name="photo" value=${bdetail.photo} > <br><br>

DATE : <input type="text" name="regdate" value=${bdetail.regdate}>  <h5>ex)2016-01-18</h5><br><br>
